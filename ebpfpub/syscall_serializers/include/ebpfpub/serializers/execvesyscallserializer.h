...
class ExecveSyscallSerializer final : public IFunctionSerializer {
  struct PrivateData;
  std::unique_ptr<PrivateData> d;

public:
  ExecveSyscallSerializer(IBufferStorage &buffer_storage);
  virtual ~ExecveSyscallSerializer() override;
